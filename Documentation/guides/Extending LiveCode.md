...
> found in the OpenXTalk Documentation Format Reference. This data will
> also appear in the dictionary.

#### Importing libraries
The OpenXTalk builder syntax is broken down into **modules**. There are 3
classes of module:

Type|Description
---|---
Default|These modules are part of OpenXTalk builder and are included by default. Their syntax is always available to you as a OpenXTalk developer.
Optional|These modules are created and distributed by OpenXTalk Ltd and must be imported by the extension developer in order to make use of their syntax.
...
OpenXTalk builder contains the following modules:

Module|Type|Description
---|---|---
com.OpenXTalk.canvas|Optional|Provides the syntax and types for 2D drawing allowing developers to draw to a canvas. Required if creating a widget.
com.OpenXTalk.widget|Optional|Contains syntax specific to widget building such as "my width" and "the mouse position".
com.OpenXTalk.engine|Optional|Contains syntax for all extension building such as "dispatch" and "log".
com.OpenXTalk.arithmetic|Default|Contains syntax for basic mathematical operations.
com.OpenXTalk.array|Default|Contains syntax for operations on arrays.
com.OpenXTalk.assert|Default|Contains syntax for making assertions about program state.
com.OpenXTalk.binary|Default|Contains syntax for operations on binary data.
com.OpenXTalk.bitwise|Default|Contains syntax for bitwise logical operators.
com.OpenXTalk.byte|Default|Contains syntax for operations on byte chunks.
com.OpenXTalk.char|Default|Contains syntax for operations on char chunks.
com.OpenXTalk.codeunit|Default|Contains syntax for operations on codeunit chunks.
com.OpenXTalk.date|Default|Contains syntax for accessing the date and time.
com.OpenXTalk.file|Default|Contains syntax for file I/O operations.
com.OpenXTalk.foreign|Default|Provides the type bindings for foreign types.
com.OpenXTalk.java|Default|Provides helper functions and types for interfacing with Java.
com.OpenXTalk.list|Default|Contains syntax for operations on lists.
com.OpenXTalk.logic|Default|Contains syntax for logical operators.
com.OpenXTalk.math|Default|Contains syntax for mathematical operations.
com.OpenXTalk.mathfoundation|Default|Contains syntax for foundational mathematical operations.
com.OpenXTalk.objc|Default|Provides helper functions and types for interfacing with Objective-C.
com.OpenXTalk.sort|Default|Contains syntax for sorting operations.
com.OpenXTalk.stream|Default|Contains syntax for stream I/O operations.
com.OpenXTalk.string|Default|Contains syntax for operations on strings.
com.OpenXTalk.system|Default|Contains syntax for accessing system information.
com.OpenXTalk.type|Default|Contains syntax for general operations on types.
com.OpenXTalk.typeconvert|Default|Contains syntax for conversions between types.
com.OpenXTalk.unittest|Default|Contains syntax for unit testing OpenXTalk Builder programs.
